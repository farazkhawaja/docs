...
Kubernetes does not support downgrades of control-plane components. The k3s-upgrade image will refuse to downgrade K3s, failing the plan. Nodes with `cordon: true` configured in their plan will stay cordoned following the failure.
